INSERT INTO "user" (username, name, password) VALUES ('lmarquez', 'luis márquez', '$2a$10$ViHRD/9EDe9TAUkqHR8v2OqwIDadDpeUt4rgm70vi5mc4iVkA5boG');
INSERT INTO "user" (username, name, password) VALUES ('fperez', 'fulano pérez', '$2a$10$QtKGJ8cMeU0IPL852WU9JODtUDhOfhXPh3eX53rf8QaXqpjeuHxN2');
INSERT INTO "user" (username, name, password) VALUES ('mhernandez', 'mengano hernández', '$2a$10$tdG9dSeVL4C5O9kr.IVcc.9ja5RFR3gnS.MA10QlAGL89w1UpwcW.');
